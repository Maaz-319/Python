...
button1 = Button(text=' ', height=5, width=8, command=lambda: btn_func(button1), font=('Helvetica', 9, 'bold') )
button1.grid(row=0, column=0)
button2 = Button(text=' ', height=5, width=8, command=lambda: btn_func(button2), font=('Helvetica', 9, 'bold') )
button2.grid(row=0, column=1)
button3 = Button(text=' ', height=5, width=8, command=lambda: btn_func(button3), font=('Helvetica', 9, 'bold'))
button3.grid(row=0, column=2)

button4 = Button(text=' ', height=5, width=8, command=lambda: btn_func(button4), font=('Helvetica', 9, 'bold'))
button4.grid(row=1, column=0)
button5 = Button(text=' ', height=5, width=8, command=lambda: btn_func(button5), font=('Helvetica', 9, 'bold'))
button5.grid(row=1, column=1)
button6 = Button(text=' ', height=5, width=8, command=lambda: btn_func(button6), font=('Helvetica', 9, 'bold'))
button6.grid(row=1, column=2)

button7 = Button(text=' ', height=5, width=8, command=lambda: btn_func(button7), font=('Helvetica', 9, 'bold'))
button7.grid(row=2, column=0)
button8 = Button(text=' ', height=5, width=8, command=lambda: btn_func(button8), font=('Helvetica', 9, 'bold'))
button8.grid(row=2, column=1)
button9 = Button(text=' ', height=5, width=8, command=lambda: btn_func(button9), font=('Helvetica', 9, 'bold'))
