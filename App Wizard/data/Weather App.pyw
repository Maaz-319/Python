...
search_bar_image = PhotoImage(file='weatherappdata/search bar.png')
...
weather_icon_image = PhotoImage(file='weatherappdata/Weather icon.png')
weather_icon_label = Label(image=weather_icon_image, background='Light Green')
weather_icon_label.place(x=200, y=150)

weather_info_image = PhotoImage(file='weatherappdata/all_weather_info.png')
